...
function Report() {
  ...
  const handleGetBookingsByType = async () => {
    const { start, end } = dateRange;
    const bookingsCount = getBookingsByType(start, end);
              ...
              >
                ...
                {ageGroupedPassengers.below18.length > 0 ? (
                  ageGroupedPassengers.below18.map((passenger, index) => (
                    <Box
                      key={index}
                      sx={{ mb: 2, pl: 2, borderLeft: "2px solid #c8e6c9" }}
                    >
                      ...
                      <Typography variant="body2">
                        Booking Type: {passenger.bookingType}
                      </Typography>
                    </Box>
                  ))
                ) : (
                  <Typography variant="body2">
                    No passengers below 18
                  </Typography>
                )}
                ...
                {ageGroupedPassengers.aboveOrEqual18.length > 0 ? (
                  ageGroupedPassengers.aboveOrEqual18.map(
                    (passenger, index) => (
                      <Box
                        key={index}
                        sx={{ mb: 2, pl: 2, borderLeft: "2px solid #c8e6c9" }}
              ...
              >
                ...
                {pastFlights.length > 0 ? (
                  pastFlights.map((flight, index) => (
                    <Box
                      key={index}
                      sx={{ mb: 2, pl: 2, borderLeft: "2px solid #f48fb1" }}
                    >
                      <Typography variant="body2">
                        Passenger Name: {flight.name}
                      </Typography>
                      <Typography variant="body2">
                      ...
                      <Typography variant="body2">
                        Passenger Type: {flight.passengerType}
                      </Typography>
                      <Typography variant="body2">
                        Booking Type: {flight.bookingType}
                      </Typography>
                    </Box>
                  ))
                ) : (
                  <Typography variant="body2">
                    No past flights found for this route
                  </Typography>
                )}
              </Box>
            )}
