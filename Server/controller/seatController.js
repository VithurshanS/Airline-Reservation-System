...
exports.addSeat = async (req,res)=>{
    ...
    const insertSeat = `INSERT INTO seat (Seat_ID, Schedule_ID, Seat_Number, Seat_Class) VALUES (UUID(),?,?,?);`;
    db.query(insertSeat,[Schedule_ID,Seat_number,Seat_class],(error,result)=>{
        if(error){
            console.log(error);
