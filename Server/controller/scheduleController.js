...
exports.addSchedule = async (req,res) =>{
    const {Schedule_ID,Route_ID,Plane_ID,Depature_Time,Arival_Time,Economy_Fare,Business_Fare,Platinum_Fare,Status} = req.body;
    ...
    db.query(insertquery,[Schedule_ID,Route_ID,Plane_ID,Depature_Time,Arival_Time,Economy_Fare,Business_Fare,Platinum_Fare,Status],(error,result)=>{
        if(error){
